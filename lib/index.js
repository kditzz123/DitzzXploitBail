...
console.log(
  chalk.whiteBright(" Version: ") + chalk.greenBright("v1.0.0")
);

console.log(chalk.gray("\n──────────────────────────────────────────\n"));

console.log(
  chalk.cyanBright(`Creator: DitzzXploit`)
);
console.log(chalk.cyanBright("Youtube: youtube.com/@DitzzXploit"));
console.log(chalk.cyanBright("Thanks For Use Bailys"));
